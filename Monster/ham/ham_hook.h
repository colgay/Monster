...
{
public:
	//ke::Vector<void *> pre;     // pre forwards
	//ke::Vector<void *> post;    // post forwards
	...
	HamHook(void** vtable_, int entry_, void* target_, bool voidcall, bool retbuf, int paramcount, const char* name) :
